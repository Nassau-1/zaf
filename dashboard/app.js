  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="zaf-launch-close" title="Close" aria-label="Close modal">✕</button>
      </div>
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="max-width:440px">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="prog-modal-close" aria-label="Close modal">✕</button>
      </div>
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="width:600px;max-width:calc(100vw - 32px)">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="nr-close" aria-label="Close modal">✕</button>
      </div>
  ...
  function makeTabHtml({ meta }) {
    ...
    return `
      <div class="console-tab ${isActive?'active':''}" data-process-id="${meta.processId}">
        ...
        <span class="tab-close" data-close="${meta.processId}" title="Remove from tabs" role="button" aria-label="Close tab" tabindex="0">✕</span>
      </div>`;
  }
  ...
  const html = `
    ...
    <aside class="zaf-agent-flyout-panel" role="dialog" aria-label="Agent ${safeHTML(a.roleName || key)}">
      <header style="display:flex;justify-content:space-between;align-items:center;padding:14px 18px;border-bottom:1px solid var(--border-subtle);">
        ...
        <button class="zaf-launch-close" id="zaf-agent-flyout-close" title="Close" aria-label="Close modal">✕</button>
      </header>
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="max-width:680px;width:90vw">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="roles-close" aria-label="Close modal">✕</button>
      </div>
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="max-width:760px;width:90vw">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="org-picker-close" title="Close" aria-label="Close modal">✕</button>
      </div>
