...
function renderCliHubCards(allHarnesses, agentUsage) {
...
function renderCliHubGithubHtml(github) {
  return `
...
function renderCliHubBackupHtml() {
  return `
    <div class="zaf-control-card" style="margin-top:24px">
...
function renderCliHubAddCustomHtml() {
  return `
    <div class="zaf-control-card" style="margin-top:24px">
...
function renderControlCliHub() {
  ...
  const cardsHtml = renderCliHubCards(allHarnesses, agentUsage);

  const githubHtml = renderCliHubGithubHtml(github);

  const backupHtml = renderCliHubBackupHtml();

  const addCustomHtml = renderCliHubAddCustomHtml();
