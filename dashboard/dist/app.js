    ...
    <div class="zaf-control-grid">
      <div class="zaf-control-card">
        ...
        <form id="zaf-agent-form" style="display:flex;flex-direction:column;gap:12px;">
          ...
          <div class="zaf-field">
            <label for="agent-modelid">Model ${recBadgeHtml}</label>
            <div class="model-row">
          ...
          <div class="zaf-field"><label for="agent-struct-role">Structural Role (alters generated persona & bounds)</label>
            <div style="display:flex;gap:8px;align-items:center">
          ...
          <details class="agent-advanced-section">
            ...
            <div class="agent-advanced-inner">
              <div class="zaf-field"><label for="agent-heartbeat"><span>Heartbeat Interval</span><span class="zaf-heartbeat-val" id="heartbeat-val">${formatHeartbeat(a.heartbeat || 40)}</span></label>
