...
// Performance optimization: Debounce frequent events (e.g. search inputs) to prevent unnecessary re-renders.
...
function renderBoard(container) {
  ...
  // Performance optimization: debounce board search
  container.querySelector('#board-search')?.addEventListener('input', debounce(e => { STATE.filters.search = e.target.value; renderBoard(container); }, 300));
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="zaf-launch-close" title="Close" aria-label="Close">✕</button>
      </div>
...
function renderArchive(container) {
  ...
  // Performance optimization: debounce archive search
  container.querySelector('#archive-search').addEventListener('input', debounce(e => { STATE.filters.search = e.target.value; renderArchive(container); }, 300));
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="width:600px;max-width:calc(100vw - 32px)">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="nr-close" aria-label="Close">✕</button>
      </div>
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="max-width:680px;width:90vw">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="roles-close" aria-label="Close">✕</button>
      </div>
...
function openOrgAgentPicker() {
  ...
  modal.innerHTML = `
    ...
    <div class="zaf-launch-panel" style="max-width:760px;width:90vw">
      <div class="zaf-launch-header">
        ...
        <button class="zaf-launch-close" id="org-picker-close" title="Close" aria-label="Close">✕</button>
      </div>
  ...
  // Performance optimization: debounce org picker search
  qEl.addEventListener('input', debounce(renderList, 300));
